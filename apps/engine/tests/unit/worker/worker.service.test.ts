...
describe("WorkerService", () => {
  ...
  describe("updateJobStatus", () => {
    it("should update job status", async () => {
      const workerRepository = createMockWorkerRepository();
      const workerJobRepository = createMockWorkerJobRepository();
      const job = makeWorkerJob({ status: "ready" });
    ...
    it("should pass failReason when updating to failed status", async () => {
      const workerRepository = createMockWorkerRepository();
      const workerJobRepository = createMockWorkerJobRepository();
      const job = makeWorkerJob({ status: "in_progress" });
      const updatedJob = makeWorkerJob({ status: "failed", failReason: "Something broke" });
  ...
  describe("listJobs", () => {
    ...
    it("should return paginated jobs filtered by status", async () => {
      const workerRepository = createMockWorkerRepository();
      const workerJobRepository = createMockWorkerJobRepository();
      const jobs = [makeWorkerJob({ worker: `/workers/${WORKER_UUID}`, status: "ready" })];
