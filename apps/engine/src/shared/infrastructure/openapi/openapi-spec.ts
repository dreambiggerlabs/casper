export class OpenApiSpec {
  ...
  private buildPaths() {
    return {
      ...this.buildProjectPaths(),
      ...this.buildAgentPaths(),
      ...this.buildUserPaths(),
      ...this.buildWorkerPaths(),
      ...this.buildJobPaths(),
      ...this.buildTaskPaths(),
    };
  }
    ...
    return {
      ...
      schemas: {
        ...
        PartialCollectionView: {
          ...
          properties: {
            "@id": { type: "string" },
            "@type": { type: "string", enum: ["PartialCollectionView"] },
            first: { type: "string" },
            last: { type: "string" },
            next: { type: "string" },
